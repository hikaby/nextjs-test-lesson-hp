      ...
      <div className='bg-white text-center shadow-xl p-8 w-80 rounded'>
        ...
        <div className='mt-6 flex justify-around'>
          <div>
            ...
            >
              <svg
                className="w-6 h-6 mr-3 text-blue-500 hover:opacity-70"
                stroke="currentColor"
                fill="currentColor"
                viewBox="0 0 512 512"
          ...
          <div>
            ...
            >
              <svg
                className="w-6 h-6 mr-3 text-blue-700 hover:opacity-70"
                fill="currentColor"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
          ...
          <div>
            ...
            >
              <svg
                className="w-6 h-6 mr-3 text-gray-500 hover:opacity-70"
                fill="currentColor"
                viewBox="0 0 512 512"
                xmlns="http://www.w3.org/2000/svg"
              >
